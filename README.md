...
- Defeitos ranqueados por impacto na decisão, não por prevalência. O defeito em `7º` por prevalência sobe para `3º` por impacto, e o `4º` inverte exatamente zero decisões.
